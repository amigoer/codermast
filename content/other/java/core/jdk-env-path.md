...
```mermaid
flowchart TD
    subgraph JDK["JDK<br/>+ 编译器 #40;javac#41;<br/>+ 调试器 #40;jdb#41;<br/>+ 其他开发工具"]
        subgraph JRE["JRE<br/>+ 核心类库 #40;rt.jar#41;<br/>+ 扩展类库"]
            JVM["JVM<br/>• 类加载器<br/>• 执行引擎<br/>• 垃圾回收器<br/>• 运行时数据区"]
        end
    end
```
