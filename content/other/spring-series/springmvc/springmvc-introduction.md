...
```mermaid
flowchart TD
    A["1. 用户发送请求"] --> B["2. DispatcherServlet #40;前端控制器#41;"]
    B --> C["3. HandlerMapping #40;处理器映射器#41;<br/>找到对应的 Handler"]
    B --> D["4. HandlerAdapter #40;处理器适配器#41;<br/>执行 Handler"]
    B --> E["5. Handler #40;控制器#41;<br/>处理业务，返回 ModelAndView"]
    B --> F["6. ViewResolver #40;视图解析器#41;<br/>解析视图名称"]
    B --> G["7. View #40;视图#41;<br/>渲染数据，返回响应"]
```
