...
```mermaid
flowchart TD
    subgraph SC["Spring Cloud 生态"]
        A1["服务注册发现<br/>Nacos / Eureka"]
        A2["配置中心<br/>Nacos Config / Apollo"]
        A3["服务网关<br/>Gateway / Zuul"]
        B1["服务调用<br/>OpenFeign / RestTemplate"]
        B2["负载均衡<br/>LoadBalancer / Ribbon"]
        B3["服务保护<br/>Sentinel / Hystrix"]
        C1["分布式事务<br/>Seata"]
        C2["链路追踪<br/>Sleuth / Zipkin"]
        C3["消息总线<br/>Bus / Stream"]
    end
```
