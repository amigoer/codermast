...
```mermaid
flowchart TD
    subgraph Nacos["注册中心 #40;Nacos#41;"]
        Registry["服务注册表<br/>user-service: [192.168.1.10:8081, 192.168.1.11:8081]<br/>order-service: [192.168.1.20:8082]"]
    end
    User["用户服务<br/>8081"]
    Order["订单服务<br/>8082"]
    User -->|① 注册 / ④ 心跳| Nacos
