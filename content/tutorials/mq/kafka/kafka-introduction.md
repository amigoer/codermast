...
flowchart TD
    ...
    subgraph Cluster["Kafka Cluster"]
        B0["Broker 0<br/>Topic-A<br/>P0#40;L#41; P1#40;F#41;"]
        B1["Broker 1<br/>Topic-A<br/>P1#40;L#41; P2#40;F#41;"]
        B2["Broker 2<br/>Topic-A<br/>P2#40;L#41; P0#40;F#41;"]
    end
...
```mermaid
flowchart LR
    subgraph T["Topic: orders #40;3 partitions, 2 replicas#41;"]
        B0["Broker 0<br/>P0 #40;L#41;<br/>P1 #40;F#41;"]
        B1["Broker 1<br/>P1 #40;L#41;<br/>P2 #40;F#41;"]
        B2["Broker 2<br/>P2 #40;L#41;<br/>P0 #40;F#41;"]
    end
```
...
```mermaid
flowchart LR
    subgraph T["Topic: orders #40;3 partitions#41;"]
        P0["P0"]
        P1["P1"]
        P2["P2"]
    end
