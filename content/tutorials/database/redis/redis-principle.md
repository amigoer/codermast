...
```mermaid
flowchart TD
    A["客户端请求"] --> B["IO 多线程<br/>读取请求、写入响应"]
    B --> C["主线程执行<br/>命令执行#40;单线程#41;"]
```
...
flowchart TD
    subgraph EL["Event Loop"]
        Mux["epoll/kqueue/select"]
        Handler["事件处理器<br/>• 连接处理器<br/>• 命令处理器<br/>• 响应处理器"]
        Mux --> Handler
    end
    C1["Client1"] --> Mux
    C2["Client2"] --> Mux
...
flowchart LR
    ...
    subgraph L3["Level 3"]
        L3_1["1"] --> L3_5["5"] --> L3_9["9"]
    end
    subgraph L2["Level 2"]
        L2_1["1"] --> L2_3["3"] --> L2_5["5"] --> L2_7["7"] --> L2_9["9"]
    end
    subgraph L1["Level 1"]
        L1_1["1"] --> L1_2["2"] --> L1_3["3"] --> L1_4["4"] --> L1_5["5"] --> L1_6["6"] --> L1_7["7"] --> L1_8["8"] --> L1_9["9"]
    end
```
