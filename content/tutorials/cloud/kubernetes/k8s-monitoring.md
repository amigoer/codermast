...
flowchart TD
    subgraph PS["Prometheus Server"]
        R["Retrieval<br/>#40;抓取数据#41;"]
        T["TSDB<br/>#40;时序数据库#41;"]
        H["HTTP Server<br/>#40;查询接口#41;"]
    end
    E["Exporters<br/>#40;Node/Pod/App#41;"]
    G["Grafana<br/>#40;可视化#41;"]
    subgraph K8s["Kubernetes Cluster"]
        Nodes["Node / Pod / Service / Deployment"]
    end
    E -- "Pull" --> R
    H -- "Query" --> G
    Nodes --> E
...
flowchart BT
    ...
    N2["Node 2<br/>[Pod]"]
    N3["Node 3<br/>[Pod]"]
    F["Fluentd / Fluent Bit<br/>#40;日志采集 DaemonSet#41;"]
    ES["Elasticsearch<br/>#40;日志存储和索引#41;"]
    K["Kibana<br/>#40;可视化查询#41;"]
    N1 --> F
    N2 --> F
    N3 --> F
    F -- "Push" --> ES
