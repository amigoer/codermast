...
flowchart TD
    ...
    subgraph Agent["AI Agent"]
        Perception["感知层<br/>Perception"]
        Memory["记忆系统<br/>Memory"]
        Planning["规划引擎<br/>Planning / Reasoning"]
        Action["执行层<br/>Action / Tool Use"]
        Perception --> Planning
        Memory --> Planning
        Planning --> Action
    end
    Agent --> Result["执行结果 / 环境反馈"]
```
...
```mermaid
flowchart TD
    Input["用户输入"] --> Eval["任务复杂度评估"]
    Eval --> Simple["简单任务"]
    Eval --> Complex["复杂任务"]
    Simple --> Fast["快速响应<br/>#40;反应式#41;"]
    Complex --> Deep["深度规划<br/>#40;审议式#41;"]
    Fast --> Out["输出结果"]
    Deep --> Out
```
...
```mermaid
flowchart TD
    Orch["协调者#40;Orchestrator#41;"]
    Orch --> R["研究员<br/>Research"]
    Orch --> C["程序员<br/>Coder"]
    Orch --> V["审查员<br/>Reviewer"]
```
