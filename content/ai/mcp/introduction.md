...
flowchart LR
    ...
    subgraph MCPWay["MCP 方式"]
        M_A1["AI App 1"] --> MCP["MCP"]
        M_A2["AI App 2"] --> MCP
        MCP --> M_TA["Tool A #40;MCP Server#41;"]
        MCP --> M_TB["Tool B #40;MCP Server#41;"]
        MCP --> M_TC["Tool C #40;MCP Server#41;"]
    end
```
...
```mermaid
flowchart TD
    subgraph Host["Host #40;AI 应用#41;"]
    ...
    ServerA["MCP Server A<br/>#40;文件系统#41;"]
    ServerB["MCP Server B<br/>#40;数据库#41;"]
    ClientA --> ServerA
    ClientB --> ServerB
```
...
```mermaid
flowchart LR
    Server["Server"] -->|请求采样| Client["Client"]
    Client -->|调用模型| Model["AI Model"]
    Model -->|模型响应| Client
    Client -->|返回结果| Server
```
