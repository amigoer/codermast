...
<Warning title="为什么不使用 a 标签来进行页面的跳转呢？">
...
<Note title="路由的映射关系中，也支持配置子路由，便于 URL 匹配，支持多级子路由嵌套">
</Note>
...
```
<Note title="与路由一样，to 属性在实现跳转功能的同时，也能传递参数">
</Note>
...
<Warning title="&lt;router-link&gt; 和 &lt;router-link&gt; 也可以写成 &lt;RouterLink&gt; 和 &lt;RouterView&gt; 这种组件形式">
</Warning>
...
<Warning title="实际的开发中，使用编程式导航的情况远远大于链接式。">
</Warning>
