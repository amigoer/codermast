    ...
    groups: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'Agent SDK', path: '/ai/agent/sdk' },
          { title: 'Hooks 自动化', path: '/ai/agent/hooks' },
          { title: 'Subagents', path: '/ai/agent/subagents' },
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'Tools 深入', path: '/ai/mcp/tools' },
          { title: '调试与排错', path: '/ai/mcp/debugging' },
        ],
      },
      {
        title: 'Agent Skills',
        ...
        children: [
          { title: '概述', path: '/ai/skills/introduction' },
          { title: '创建 Skill', path: '/ai/skills/creating' },
          { title: '最佳实践', path: '/ai/skills/best-practices' },
        ],
      },
    ],
  },
