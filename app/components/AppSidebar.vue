<template>
  <aside
    class="sidebar-scroll h-[calc(100vh-4rem)] w-64 shrink-0 overflow-y-auto border-r border-gray-200 bg-white pb-8 pt-4 dark:border-gray-800 dark:bg-gray-900"
  >
    <!-- Mobile tabs -->
